...
class BiLSTMCRFModel(nn.Module):
    ...
    def _viterbi_decode(self, feats):
        ...
        for feat in feats:
            ...
            for next_tag in range(self.tagset_size):
                ...
                next_tag_var = forward_var + self.transitions.cpu()[next_tag]  # # CPU上使用转移矩阵
        ...
        # 转移到STOP_TAG
        terminal_var = forward_var + self.transitions.cpu()[self.tag_to_ix[self.stop_tag]]  # # CPU上使用转移矩阵
    ...
    def forward(self, sentence):
        ...
        score, tag_seq = self._viterbi_decode(lstm_feats.cpu())  # # 在cpu上进行维特比
